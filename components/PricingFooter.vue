      ...
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        ...
        <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div v-for="section in leftSections" :key="section.title">
              <h3 class="text-sm/6 font-semibold text-gray-900">{{ section.title }}</h3>
          ...
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div v-for="section in rightSections" :key="section.title">
              <h3 class="text-sm/6 font-semibold text-gray-900">{{ section.title }}</h3>
              <ul role="list" class="mt-6 space-y-4">
                <li v-for="link in section.links" :key="link.name">
                  <a :href="link.href" class="text-sm/6 text-gray-600 hover:text-gray-900">
