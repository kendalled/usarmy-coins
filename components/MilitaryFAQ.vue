<template>
  <div class="bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 py-16 md:py-24">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[84rem]">
      ...
      <div class="max-w-4xl mx-auto space-y-4">
        <div 
          ...
          :key="index"
          class="bg-slate-800/50 backdrop-blur-sm rounded-xl shadow-lg ring-1 ring-white/5 overflow-hidden"
        >
          <button
