      ...
      <div class="max-w-336 mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center mb-16">
          <h1 class="text-4xl md:text-6xl font-bold text-white mb-6">
            Our <span class="text-transparent bg-clip-text bg-linear-to-r from-orange-500 to-orange-600">Coins</span> Gallery
          </h1>
        ...
        <!-- Filter Controls -->
        <div class="bg-slate-800/80 backdrop-blur-xs rounded-xl p-6 shadow-xl ring-1 ring-white/5 mb-12">
