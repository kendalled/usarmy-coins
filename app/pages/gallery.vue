<template>
  <div class="min-h-screen bg-slate-900">
    ...
    <div class="pt-32">
      <!-- Hero Section -->
      <div class="max-w-336 mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center mb-16">
          <h1 class="text-4xl md:text-6xl font-bold text-white mb-6">
            Our
            <span
              class="text-transparent bg-clip-text bg-linear-to-r from-orange-500 to-orange-600"
              >Coins</span
            >
            Gallery
          </h1>
          <p class="text-xl text-slate-300 max-w-3xl mx-auto">
            Explore our portfolio of custom military challenge coins crafted for
            units across all branches of the US Armed Forces
          </p>
        </div>

        <!-- Filter Controls -->
        <div
          class="bg-slate-800/80 backdrop-blur-xs rounded-xl p-6 shadow-xl ring-1 ring-white/5 mb-12"
        >
        ...
        >
          <div
            ...
            class="group cursor-pointer bg-slate-800/60 backdrop-blur-xs rounded-xl overflow-hidden shadow-xl ring-1 ring-white/5 hover:ring-orange-500/10 transition-all duration-300 hover:-translate-y-1"
          >
            <!-- Coin Image -->
            ...
            <div class="p-6">
              <div class="flex items-center gap-2 mb-3">
                <span
                  :class="getBranchColor(coin.branch)"
              ...
              <h3
                class="text-lg font-semibold text-white mb-2 group-hover:text-orange-400 transition-colors duration-300"
              >
                {{ coin.unit }}
              </h3>
        ...
        <div class="text-center mt-16" v-if="hasMoreCoins">
          <button
            @click="loadMoreCoins"
            class="bg-linear-to-r from-orange-500 to-orange-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-orange-600 hover:to-orange-700 transition-all duration-300 hover:-translate-y-0.5 shadow-lg"
          >
            Load More Coins
          </button>
        </div>
    ...
    >
      <div
        v-if="lightboxOpen"
        @click="closeLightbox"
        class="fixed inset-0 bg-black/90 backdrop-blur-xs z-50 flex items-center justify-center p-4"
      >
        <Transition
          appear
          enter-active-class="ease-out duration-300"
        ...
        >
          <div
            @click.stop
            class="relative transform overflow-hidden bg-slate-800 shadow-2xl sm:max-w-6xl sm:w-full sm:rounded-2xl"
          >
            ...
            <div class="absolute right-0 top-0 hidden pr-4 pt-4 sm:block">
              <button
                @click="closeLightbox"
                type="button"
                class="rounded-md bg-slate-800 text-slate-400 hover:text-slate-300 focus:outline-hidden focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-slate-800"
              >
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div class="flex flex-col justify-between p-6 sm:p-8 lg:p-12">
                ...
                <div>
                  <div class="mb-4">
                    <div
                      class="inline-flex items-center rounded-full bg-orange-500/10 px-3 py-1 text-sm font-medium text-orange-400"
                    >
                      {{ selectedCoin?.branch }}
                    </div>
                  </div>
                ...
                <!-- Navigation Footer -->
                <div
                  class="mt-8 flex items-center justify-between border-t border-slate-700 pt-6"
                >
                  <button
                    @click="previousCoin"
                    :disabled="currentIndex === 0"
                    type="button"
                    class="inline-flex items-center gap-x-2 rounded-md bg-slate-700 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs ring-1 ring-inset ring-slate-600 hover:bg-slate-600 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <svg
  ...
  meta: [
    {
      name: "description",
      content:
        "Browse our portfolio of custom military challenge coins crafted for units across all branches of the US Armed Forces.",
    },
    {
      name: "keywords",
      content:
        "military challenge coins, custom coins, army coins, navy coins, air force coins, marine corps coins",
    },
  ],
});
...
const allCoins = ref([
  {
    ...
    branch: "Army",
    description:
      "Custom challenge coin featuring the Screaming Eagles emblem with airborne wings and division insignia.",
    date: "March 2024",
    size: '2.0"',
  ...
  },
  {
    ...
    branch: "Navy",
    description:
      "Elite SEAL team challenge coin with trident emblem and team motto in raised relief.",
    date: "March 2024",
    size: '1.75"',
  ...
  },
  {
    ...
    branch: "Air Force",
    description:
      "Fighter wing challenge coin showcasing F-16 aircraft with wing emblem and base location.",
    date: "February 2024",
    size: '2.0"',
    plating: "Silver",
    edge: "Reeded Edge",
  ...
  },
  {
    ...
    branch: "Marine Corps",
    description:
      "Marine Corps division coin featuring eagle, globe, and anchor with divisional history.",
    date: "February 2024",
    size: '1.75"',
  ...
  },
  {
    ...
    branch: "Army",
    description:
      "All American division coin with paratrooper wings and AA emblem in vibrant colors.",
    date: "January 2024",
    size: '2.0"',
    plating: "Gold",
    edge: "Rope Edge",
  ...
  },
  {
    ...
    branch: "Navy",
    description:
      "Aircraft carrier challenge coin commemorating deployment with ship silhouette.",
    date: "January 2024",
    size: '2.25"',
    plating: "Silver",
    edge: "Cut Edge",
  ...
  },
  {
    ...
    branch: "Air Force",
    description:
      "Combat fighter wing coin featuring F-22 Raptor with wing heritage design.",
    date: "December 2023",
    size: '1.75"',
  ...
  },
  {
    ...
    branch: "Marine Corps",
    description:
      "MEF challenge coin with amphibious assault theme and unit lineage.",
    date: "December 2023",
    size: '2.0"',
    plating: "Copper",
    edge: "Diamond Cut",
  ...
  },
  {
    ...
    branch: "Coast Guard",
    description:
      "Coast Guard station coin featuring lighthouse and rescue operations theme.",
    date: "November 2023",
    size: '1.75"',
    plating: "Antique Silver",
    edge: "Rope Edge",
  ...
  },
  {
    ...
    branch: "Space Force",
    description:
      "Space Force command coin with orbital design and guardian wings.",
    date: "October 2023",
    size: '2.0"',
    plating: "Black Nickel",
    edge: "Cut Edge",
...
const hasMoreCoins = computed(() => {
  ...
  if (selectedBranch.value !== "All Branches") {
    totalFiltered = totalFiltered.filter(
      (coin) => coin.branch === selectedBranch.value,
    );
  }
