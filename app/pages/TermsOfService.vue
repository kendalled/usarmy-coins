    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
      ...
      >
        ...
        <p class="text-slate-300 mb-4">
          By accessing or using the US Army Coins website and services, you
        ...
        <ul class="list-disc list-inside text-slate-300 mb-4">
          <li>
            Custom products are non-refundable unless defective or incorrect.
          </li>
        ...
        <p class="text-slate-300 mb-4">
          All content, designs, and images on this site are the property of US
          Army Coins or its licensors. You may not use, reproduce, or distribute
