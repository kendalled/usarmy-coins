<template>
  <div class="min-h-screen bg-slate-900 py-16">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
      <div
        class="bg-slate-800/95 backdrop-blur-xs rounded-xl p-8 shadow-xl ring-1 ring-white/5"
      >
        <h1 class="text-3xl font-bold text-white mb-6">Privacy Policy</h1>
        <p class="text-slate-300 mb-4">Effective Date: May 2024</p>
        <h2 class="text-xl font-semibold text-orange-500 mt-8 mb-2">
          1. Introduction
        </h2>
        <p class="text-slate-300 mb-4">
          US Army Coins ("we", "us", or "our") is committed to protecting your
          privacy. This Privacy Policy explains how we collect, use, disclose,
          and safeguard your information when you visit our website and purchase
          our products.
        </p>
        <h2 class="text-xl font-semibold text-orange-500 mt-8 mb-2">
        ...
        <ul class="list-disc list-inside text-slate-300 mb-4">
          <li>
            ...
            Name, email address, shipping address, phone number, and payment
            information.
          </li>
          <li>
            <span class="font-semibold text-white">Order Information:</span>
            Details about your orders and purchase history.
          </li>
          <li>
        ...
        <p class="text-slate-300">
          ...
          at
          <a
            href="mailto:support@usarmycoins.com"
            class="text-orange-400 underline"
            >support@usarmycoins.com</a
          >.
        </p>
      </div>
    </div>
