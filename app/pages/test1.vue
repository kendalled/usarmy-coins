  ...
  <footer aria-labelledby="footer-heading" class="bg-gray-900">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 md:mt-16 xl:mt-0">
          ...
          <form class="mt-2 flex sm:max-w-md">
            ...
            <div class="ml-4 shrink-0">
              <button type="submit" class="flex w-full items-center justify-center rounded-md border border-transparent bg-orange-600 px-4 py-2 text-base font-medium text-white shadow-xs hover:bg-orange-700 focus:outline-hidden focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-gray-900">Sign up</button>
            </div>
          </form>
        </div>
      </div>
      ...
      <div class="border-t border-gray-800 py-10">
        <p class="text-sm text-gray-400">Copyright &copy; 2025 US Army Coins, LLC.</p>
      </div>
    </div>
  </footer>
</div>
