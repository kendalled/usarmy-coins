    ...
    <main>
      ...
      >
        <div class="relative overflow-hidden rounded-lg">
          ...
          <div
            class="relative bg-gray-900/75 px-6 py-32 sm:px-12 sm:py-40 lg:px-16"
          >
            <div
            ...
            >
              ...
              >
                <span class="block sm:inline">Custom coins</span>
                <span class="block sm:inline"> for every branch</span>
              </h2>
              <p class="mt-3 text-xl text-white">
                Since 1999, we have produced custom coins for our first
                responders, soldiers, and countless others. From complimentary
                art proofs to industry-leading pricing, you know you are making
                the right choice when you order with us.
              </p>
              <a
                href="/"
      ...
      >
        ...
        >
          ...
          <a href="/" class="group block">
            ...
            <p class="mt-2 text-sm text-gray-500">
              The rest of the house will still be a mess, but your desk will
              look great.
            </p>
          </a>
          <a href="/" class="group block">
            <img
              src="/tests/test_3.jpeg"
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div class="mt-12 md:mt-16 xl:mt-0">
            ...
            <form class="mt-2 flex sm:max-w-md">
              ...
              <input
                ...
                autocomplete="email"
                required
                class="w-full min-w-0 appearance-none rounded-md border border-white bg-white px-4 py-2 text-base text-gray-900 placeholder-gray-500 shadow-xs focus:border-white focus:outline-hidden focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-900"
              />
              <div class="ml-4 shrink-0">
                <button
                  type="submit"
                  class="flex w-full items-center justify-center rounded-md border border-transparent bg-orange-600 px-4 py-2 text-base font-medium text-white shadow-xs hover:bg-orange-700 focus:outline-hidden focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-gray-900"
                >
                  Sign up
                </button>
              </div>
        ...
        <div class="border-t border-gray-800 py-10">
          <p class="text-sm text-gray-400">
            Copyright &copy; 2025 US Army Coins, LLC.
          </p>
        </div>
      </div>
    </footer>
