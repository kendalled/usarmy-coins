<template>
            ...
            <div class="inline-block">
              ...
              >
                <select
                  id="mobile-currency"
                  name="currency"
                  class="flex items-center rounded-md border-transparent bg-none py-0.5 pl-2 pr-5 text-sm font-medium text-gray-700 focus:border-transparent focus:outline-hidden focus:ring-0 group-hover:text-gray-800"
                >
                  <option>USD</option>
                  <option>CAD</option>
                  <option>AUD</option>
  ...
  <div class="relative bg-gray-900">
              ...
              <div>
                ...
                >
                  <select
                    id="desktop-currency"
                    name="currency"
                    class="flex items-center rounded-md border-transparent bg-gray-900 bg-none py-0.5 pl-2 pr-5 text-sm font-medium text-white focus:border-transparent focus:outline-hidden focus:ring-0 group-hover:text-gray-100"
                  >
                    <option>USD</option>
                    <option>CAD</option>
                    <option>AUD</option>
                  ...
                  <!-- todo: maybe remove -->
                  <div
                    class="pointer-events-none absolute inset-y-0 right-[-0.12rem] flex items-center"
                  >
                    <svg
    ...
    <div
      class="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-56 lg:px-0"
    >
      <h1 class="text-4xl font-bold tracking-tight text-white lg:text-6xl">
        Custom Military Challenge Coins to Honor Our Heroes
      </h1>
      <p class="mt-4 text-xl text-white">
        Custom military challenge coins are a lasting symbol of honor, loyalty,
        and camaraderie. At US Army Coins, we specialize in creating
        high-quality, custom designs that pay tribute to the brave men and women
        who serve our country. Get started with a free art proof today.
      </p>
      <a
        href="#"
