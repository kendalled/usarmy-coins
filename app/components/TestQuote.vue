<template>
  <div class="min-h-screen bg-linear-to-br from-gray-900 via-gray-800 to-amber-900/30 pt-32 pb-32">

    <!-- Breadcrumb -->
    <nav aria-label="Breadcrumb" class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-336 pb-8">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-336">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-9 gap-8 lg:gap-12">
        ...
        <div class="lg:col-span-4 space-y-8">
          <!-- Main Product Image -->
          <div class="bg-linear-to-br from-slate-800 via-slate-800 to-slate-900 rounded-2xl p-8 aspect-square flex items-center justify-center shadow-xl ring-1 ring-white/5">
            <img 
          ...
          <!-- Thumbnail Gallery -->
          <div class="bg-black/20 backdrop-blur-xs rounded-xl p-4 ring-1 ring-white/5">
          ...
          <div class="bg-black/20 backdrop-blur-xs rounded-xl ring-1 ring-white/5 shadow-lg">
        ...
        <div class="lg:col-span-5 space-y-6">
          ...
          <div class="bg-slate-800/80 backdrop-blur-xs rounded-xl p-6 shadow-xl ring-1 ring-white/5">
          ...
          <div ref="pricingSummary" class="sticky bottom-6">
            <div class="bg-slate-800/95 backdrop-blur-xs rounded-xl p-6 shadow-xl ring-1 ring-white/5">
    ...
    <div v-show="false" class="mt-24 w-full bg-linear-to-b from-transparent via-slate-900/50 to-slate-900/50">
    ...
    >
      <div v-if="showContactForm" class="relative z-50" role="dialog" aria-modal="true">
        <!-- Background backdrop -->
        <div class="fixed inset-0 bg-black/50 backdrop-blur-xs" @click="closeContactForm"></div>
    ...
    >
      <div v-if="showSuccessModal" class="relative z-50" role="dialog" aria-modal="true">
        <!-- Background backdrop -->
        <div class="fixed inset-0 bg-black/50 backdrop-blur-xs" @click="closeSuccessModal"></div>
