    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div class="space-y-4">
          <div class="flex items-center">
            <svg class="h-8 w-8 mr-2" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <rect x="14" y="10" width="12" height="20" rx="6" fill="#ea580c" />
              <circle cx="20" cy="20" r="4" fill="#fff" />
            </svg>
            <span class="text-white font-bold text-xl">US Army Coins</span>
          </div>
          <p class="text-slate-400 text-sm">Premium custom challenge coins for military units, first responders, and organizations. Made in the USA with pride.</p>
          <div class="flex space-x-4">
            <a href="#" class="text-slate-400 hover:text-orange-500 transition-colors">
        ...
        <div>
          ...
          <address class="not-italic space-y-2">
            <p class="text-slate-400 text-sm">123 Military Way<br>Arlington, VA 22202</p>
            <p class="text-slate-400 text-sm">
              <a href="tel:+18005551234" class="hover:text-orange-500 transition-colors">(800) 555-1234</a>
            </p>
            <p class="text-slate-400 text-sm">
              <a href="mailto:info@usarmycoins.com" class="hover:text-orange-500 transition-colors">info@usarmycoins.com</a>
            </p>
            <p class="text-slate-400 text-sm mt-4">Mon-Fri: 9:00 AM - 5:00 PM EST</p>
          </address>
        </div>
      </div>
      ...
      <div class="mt-12 pt-8 border-t border-slate-800">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <p class="text-slate-500 text-sm">&copy; 2025 US Army Coins. All rights reserved.</p>
...
<script setup>
// No script needed for the footer component
</script>
