          ...
          <div class="p-6">
            ...
            >
              <p class="text-base">
                ...
                premium challenge coins feature high-quality metal construction
                with detailed enamel work. Each coin is crafted to honor
                military service and can be customized with unit insignia,
                mottos, and commemorative designs. Perfect for recognition
                ceremonies, unit gifts, and preserving military heritage.
              </p>
            </div>
                ...
                >
                  ...
                  >
                    ...
                    <div class="text-right flex items-center space-x-3">
                      ...
                      <span
                        v-if="option.savings"
                        class="text-xs font-semibold bg-orange-500/10 text-orange-400 px-2 py-0.5 rounded-full lg:hidden xl:inline"
                      >
                        SAVE {{ option.savings }}%
                      </span>
                    </div>
...
// All the same reactive data and logic from TestQuote component
