<template>
  ...
  <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
    ...
    <p class="mt-2 max-w-lg text-pretty text-4xl font-semibold tracking-tight text-white sm:text-5xl">Streamlined Process, Exceptional Results</p>
    ...
    <div class="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-1">
      ...
      <div class="flex p-px lg:col-span-2">
        <div class="overflow-hidden rounded-lg bg-gray-800 ring-1 ring-white/15 max-lg:rounded-t-4xl lg:rounded-tl-4xl">
      ...
      <!-- Step 2 -->
      <div class="flex p-px lg:col-span-2">
        <div class="overflow-hidden rounded-lg bg-gray-800 ring-1 ring-white/15 max-lg:rounded-t-4xl">
      ...
      <div class="flex p-px lg:col-span-4 lg:hidden">
        <div class="overflow-hidden rounded-lg bg-gray-800 ring-1 ring-white/15 max-lg:rounded-b-4xl lg:rounded-br-4xl">
