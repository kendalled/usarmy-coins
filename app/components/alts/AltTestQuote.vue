<template>
  <div class="min-h-screen bg-linear-to-br from-gray-900 via-gray-800 to-amber-900/30 pt-20">
    ...
    <div class="container mx-auto px-6 pb-12 max-w-7xl">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
          <!-- Main Product Image -->
          <div class="bg-linear-to-br from-slate-700 via-slate-800 to-slate-900 rounded-2xl p-8 aspect-square flex items-center justify-center shadow-lg ring-1 ring-slate-700/50">
            <img 
          ...
          <div class="bg-black/20 backdrop-blur-xs rounded-xl border border-amber-900/30 shadow-lg">
        ...
        <div class="space-y-6">
          <!-- Product Title -->
          <div class="bg-linear-to-r from-slate-800/80 to-slate-900/80 backdrop-blur-xs rounded-2xl p-6 border border-slate-700/50">
          ...
          <div class="bg-slate-800/60 backdrop-blur-xs rounded-2xl border border-slate-700/50 p-6 shadow-lg">
            <div class="flex items-center space-x-3 mb-6">
              <div class="w-8 h-8 bg-linear-to-br from-orange-500 to-amber-600 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-md">1</div>
