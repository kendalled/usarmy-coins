<template>
  <div
    class="min-h-screen bg-linear-to-br from-gray-900 via-gray-800 to-amber-900/30 pt-20"
  >
    <!-- Breadcrumb -->
    <div class="container mx-auto px-6 py-4 max-w-7xl">
      <nav class="flex items-center space-x-2 text-sm">
        <a href="#" class="text-orange-500 hover:text-orange-400"
          >Challenge Coins</a
        >
        <svg
    ...
    <div class="container mx-auto px-6 pb-12 max-w-7xl">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
          <!-- Main Product Image -->
          <div
            class="bg-linear-to-br from-slate-700 via-slate-800 to-slate-900 rounded-2xl p-8 aspect-square flex items-center justify-center shadow-lg ring-1 ring-slate-700/50"
          >
            <img
          ...
          <!-- Thumbnail Gallery -->
          <div class="w-full bg-black/10 backdrop-blur-xs rounded-xl p-4">
          ...
          <div
            class="bg-black/20 backdrop-blur-xs rounded-xl border border-amber-900/30 shadow-lg"
          >
            ...
            <div class="p-6">
              ...
              <div v-else-if="activeTab === 'Returns'" class="text-gray-300">
                <p>
                  ...
                  satisfied with your order, contact us within 30 days for a
        ...
        <div class="space-y-6">
          <!-- Product Title -->
          <div
            class="bg-linear-to-r from-slate-800/80 to-slate-900/80 backdrop-blur-xs rounded-2xl p-6 border border-slate-700/50"
          >
            <h2 class="text-2xl font-bold text-white mb-2">
              Custom Military Challenge Coin
            </h2>
          ...
          <div
            class="bg-slate-800/60 backdrop-blur-xs rounded-2xl border border-slate-700/50 p-6 shadow-lg"
          >
            <div class="flex items-center space-x-3 mb-6">
              <div
                class="w-8 h-8 bg-linear-to-br from-orange-500 to-amber-600 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-md"
              >
                1
              </div>
            ...
            <div class="mb-6">
              ...
              <div class="grid grid-cols-3 gap-3">
                <label
                  ...
                  :class="{
                    'border-orange-500 bg-slate-700/50 text-white':
                      selectedSize === size,
            ...
            <div>
              ...
              <div class="space-y-2 max-h-64 overflow-y-auto pr-2 -mr-2">
                <label
                  ...
                  :class="{
                    'bg-slate-700/50 border border-orange-500/30':
                      selectedQuantity === qty.amount,
                ...
                >
                  <div class="flex items-center space-x-3">
                    ...
                    >
                      <div
                        v-if="selectedQuantity === qty.amount"
                  ...
                  <div v-if="qty.amount !== 'Other'" class="text-right">
                    <div class="text-white font-medium">
                      ${{ qty.pricePerUnit }}
                      <span class="text-slate-400 text-sm">/ea</span>
                    </div>
                    <div
                      v-if="qty.savings"
              ...
              <div class="text-center mt-4">
                <button
                  class="text-orange-400 hover:text-orange-300 text-sm font-medium transition-colors flex items-center justify-center w-full"
                >
                  View bulk pricing
                  <svg
          ...
          <div class="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
            ...
            >
              <div class="flex items-center space-x-3">
                <div
                  class="w-8 h-8 bg-gray-600 rounded-full flex items-center justify-center text-white font-bold text-sm"
                >
                  2
                </div>
            ...
            <div v-if="platingExpanded" class="mt-4 space-y-3">
              ...
              >
                ...
                />
                <span
                  class="text-white group-hover:text-orange-400 transition-colors"
                  >{{ plating }}</span
                >
              </label>
            </div>
          ...
          <div class="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
            <div class="text-center mb-4">
              ...
              <div class="text-gray-500 text-xs mt-2">
                *This is a price estimate! Formal quotation requires a
