      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-12">
          ...
          <p class="text-lg text-slate-300 max-w-2xl mx-auto">
            Select your military branch and customize your challenge coins. Get
            a free same day digital proof with every quote - sent straight to
            your email.
          </p>
        </div>
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            ...
            >
              <div class="text-center">
                <div
                  class="w-24 h-24 mx-auto mb-4 rounded-xl overflow-hidden bg-slate-700/50 ring-1 ring-white/10"
                >
                  <img
                    :src="branch.image"
                    :alt="branch.name"
                ...
                <div
                  class="text-base font-semibold text-slate-200 group-hover:text-orange-400 transition-colors"
                >
                  {{ branch.name }}
                </div>
              </div>
        ...
        <div v-else class="text-center py-12">
          ...
          <p class="text-slate-400">
            Select your military branch above to start building your custom
            quote
          </p>
        </div>
      </div>
