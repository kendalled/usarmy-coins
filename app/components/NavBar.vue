  ...
  <header class="sticky inset-0 z-50 border-b border-slate-100/40 bg-white/80 backdrop-blur-lg">
    ...
    <nav class="mx-auto flex max-w-336 gap-8 px-6 transition-all duration-200 ease-in-out lg:px-5 py-4">
        ...
        <div class="hidden items-center justify-center gap-6 md:flex">
            ...
            <a href="#" class="rounded-md bg-linear-to-br from-orange-600 to-orange-400 px-3 py-1.5 font-dm text-sm font-medium text-white shadow-md shadow-orange-400/50 transition-transform duration-200 ease-in-out hover:scale-[1.03]">Get a Free Quote</a>
        </div>
