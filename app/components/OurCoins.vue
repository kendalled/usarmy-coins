<template>
  <section id="our-coins" class="py-16 md:py-24 bg-linear-to-b from-slate-900 to-slate-800 scroll-mt-16">
    <div class="container mx-auto px-4 md:px-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 md:gap-10">
        <a v-for="(coin, index) in coinTypes" :key="index" 
          ...
          <p class="text-slate-300 text-sm leading-relaxed grow">{{ coin.description }}</p>
