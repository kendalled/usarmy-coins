<template>
  ...
  >
    ...
    >
      ...
      <a
        href="#"
        class="hidden text-sm font-semibold text-yellow-600 hover:text-yellow-500 sm:block"
      >
        ...
        >
          ...
          >
            ...
            <a
              ...
              :href="branch.link"
              :title="'Custom ' + branch.name + ' Challenge Coins'"
              class="relative bg-gray-100 flex h-80 w-56 flex-col overflow-hidden rounded-lg p-6 hover:opacity-75 transition-opacity xl:w-auto"
            >
              <span aria-hidden="true" class="absolute inset-0">
                <img
                  :src="branch.image"
                  :alt="branch.name + ' Challenge Coin'"
              ...
              <span
                aria-hidden="true"
                class="absolute inset-x-0 bottom-0 h-2/3 bg-linear-to-t from-gray-800 opacity-75"
              ></span>
              <span
    ...
    <div class="mt-6 px-4 sm:hidden">
      <a
        href="#"
        class="block text-sm font-semibold text-yellow-600 hover:text-yellow-500"
      >
        Browse all categories
        <span aria-hidden="true"> &rarr;</span>
      </a>
