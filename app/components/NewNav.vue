<template>
  ...
  -->
              ...
              >
                <div class="grid grid-cols-2 gap-x-4">
                  <div class="group relative text-sm">
                    <img
                      src="/images/misc/navy-coin-example.jpg"
                  ...
                  <div class="group relative text-sm">
                    <img
                      src="/images/misc/navy-seal-challenge-coin.jpg"
    ...
    <header class="relative z-50 bg-white">
      <p
        class="flex h-10 items-center justify-center bg-yellow-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8"
      >
          ...
          <div class="flex h-16 items-center">
            ...
            <div class="ml-4 flex lg:ml-0">
              <a href="#">
                ...
                <img
                  class="h-8 w-auto"
                  src="/images/misc/us-army-coins-logo.png"
                  alt=""
                />
              </a>
            </div>
            ...
            <div class="hidden lg:ml-8 lg:block lg:self-stretch">
              <div class="flex h-full space-x-8">
                              ...
                              <div v-for="category in categories">
                                ...
                                >
                                  ...
                                  <li class="flex">
                                    <a
                                      href="#"
                                      class="hover:text-gray-800 font-medium text-yellow-600"
                                      >Browse All</a
                                    >
                                  </li>
                                </ul>
                ...
                -->
                  <div
                    class="hidden absolute inset-x-0 top-full text-sm text-gray-500"
                  >
                    <!-- Presentational element used to render the bottom shadow, if we put the shadow on the actual panel it pokes out the top, so we use this shorter element to hide the top of the shadow -->
                    <div
                      class="absolute inset-0 top-1/2 bg-white shadow"
    ...
    links: [
      {
        text: "Polished Gold",
        href: "#polished-gold",
        title: "Custom Polished Gold Challenge Coins",
      },
      {
        text: "Polished Silver",
        href: "#polished-silver",
        title: "Custom Polished Silver Challenge Coins",
      },
      {
        text: "Polished Copper",
        href: "#polished-copper",
        title: "Custom Polished Copper Challenge Coins",
      },
      {
        text: "Polished Nickel",
        href: "#polished-nickel",
        title: "Custom Polished Nickel Challenge Coins",
      },
      {
        text: "Black Metal",
        href: "#black-metal",
        title: "Custom Black Metal Challenge Coins",
      },
      {
        text: "Antique Gold",
        href: "#antique-gold",
        title: "Custom Antique Gold Challenge Coins",
      },
      {
        text: "Antique Silver",
        href: "#antique-silver",
        title: "Custom Antique Silver Challenge Coins",
      },
      {
        text: "Antique Copper",
        href: "#antique-copper",
        title: "Custom Antique Copper Challenge Coins",
      },
      {
        text: "Dual Plated",
        href: "#dual-plated",
        title: "Custom Dual Plated Challenge Coins",
      },
      {
        text: "Color Coated",
        href: "#color-coated",
        title: "Custom Color Coated Challenge Coins",
      },
    ],
  },
  {
    ...
    links: [
      ...
      { text: "Navy", href: "#navy", title: "Custom Navy Challenge Coins" },
      {
        text: "Air Force",
        href: "#air-force",
        title: "Custom Air Force Challenge Coins",
      },
      {
        text: "Marines",
        href: "#marines",
        title: "Custom Marines Challenge Coins",
      },
      {
        text: "Coast Guard",
        href: "#coast-guard",
        title: "Custom Coast Guard Challenge Coins",
      },
      {
        text: "Space Force",
        href: "#space-force",
        title: "Custom Space Force Challenge Coins",
      },
    ],
  },
  {
    ...
    links: [
      {
        text: "Poly Bag",
        href: "#poly-bag",
        title: "Custom Poly Bag Challenge Coin",
      },
      {
        text: "Acrylic Case",
        href: "#acrylic-case",
        title: "Custom Acrylic Case Challenge Coin",
      },
      {
        text: "Velvet Bag",
        href: "#velvet-bag",
        title: "Custom Velvet Bag Challenge Coin",
      },
      {
        text: "Velvet Case",
        href: "#velvet-case",
        title: "Custom Velvet Case Challenge Coin",
      },
    ],
  },
];
